...
const TWITTER_CLIENT_KEY = process.argv[3] ? process.argv[3] : "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
const TWITTER_CLIENT_SECRET = process.argv[4] ? process.argv[4] : "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
